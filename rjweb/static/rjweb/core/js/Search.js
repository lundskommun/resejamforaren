...
app.Search = L.Class.extend({
    ...
    geolocate: function(q, onSuccess) {
        ...
        $.ajax({
            url: app.ws.proxy + encodeURIComponent("http://open.mapquestapi.com/geocoding/v1/address?inFormat=json&key="
    ...
    addMarker: function(type, latLng) {
        ...
        case "start":
            ...
            break;
        case "end":
            iconUrl = DJANGO_STATIC_URL + "rjweb/img/pin_end.png";
    ...
    addSearchPins: function() {
        var self = this;
        var imgStart = $("<img id='pinbegin' class='dragpin' src='" + DJANGO_STATIC_URL + "rjweb/img/pin_begin.png' />"),
            imgEnd = $("<img id='pinend' class='dragpin' src='" + DJANGO_STATIC_URL + "rjweb/img/pin_end.png' />");
